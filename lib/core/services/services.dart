...
class PdfExportService {
  ...
  Future<File> generateReport({
    ...
    final pdf = pw.Document(
      title: 'PulseIQ Analytics Report',
      author: 'PulseIQ',
      creator: 'PulseIQ App v1.0',
    );
        ...
        child: pw.Column(
          ...
          children: [
            ...
            pw.Row(
              ...
              children: [
                pw.Text(
                  'Generated by PulseIQ — All data processed on-device',
          ...
          children: [
            ...
            pw.Container(
              ...
              child: pw.Text(
                ...
                'PulseIQ does not share your personal financial or '
...
class ShareService {
  ...
  static Future<void> shareFile(String filePath, {String? subject}) async {
    await Share.shareXFiles(
      ...
      subject: subject ?? 'PulseIQ Analytics Report',
      text: 'Your PulseIQ analytics report is attached.',
    );
  }
  ...
  static Future<void> shareViaEmail({
    ...
    final email = Email(
      body: body ?? 'Please find your PulseIQ analytics report attached.',
      subject: subject ?? 'PulseIQ Analytics Report',
      recipients: [toEmail],
